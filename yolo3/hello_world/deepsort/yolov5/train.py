...
Usage:
    $ python path/to/train.py --data coco128.yaml --weights yolov5l.pt --img 640
# python train.py --img 640 --batch 16 --epochs 600 --data data/custom_dataset.yaml --weights yolov5l.pt --multi-scale --adam
